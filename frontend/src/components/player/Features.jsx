...
const Features = ({ playerState, playerFeatures }) => {
  ...
  const { isMuted, shuffleEnabled, loopEnabled, playbackSpeed, volume } =
    playerState;
  const {
    onToggleMute,
    onToggleLoop,
    ...
    <>
      <div className="features-root">
        <div className="features-row">
          ...
          >
            {isMuted ? (
              <IoVolumeHighOutline color="#ff3c3c" size={26} />
            ) : (
          ...
          <label className="features-speed-label" htmlFor="playbackSpeed">
            <select
              ...
              readOnly
            >
              <option className="features-spped-select" value={0.75}>
                0.75x
              </option>
              <option className="features-spped-select" value={1}>
                1x
              </option>
              <option className="features-spped-select" value={1.25}>
                1.25x
              </option>
              <option className="features-spped-select" value={1.5}>
                1.5x
              </option>
              <option className="features-spped-select" value={2}>
                2x
              </option>
            </select>
          </label>
